...
rtl::module riscv_7stage
	...
	pipe::pproc instrpipe clk_i rst_i
		...
		pipe::pstage EXEC
			...
			# pipeline MEM_RESP forwarding
			begif [s&& [pipe::isworking MEM_RESP] [pipe::prr MEM_RESP rd_req]]
				begif [s== [pipe::prr MEM_RESP rd_addr] rs1_addr]
					begif [s&& [pipe::issucc MEM_RESP] [pipe::prr MEM_RESP rd_rdy]]
						pipe::accum rs1_rdata [pipe::prr MEM_RESP rd_wdata]
					endif
					begelse
						pipe::pstall
					endif
				endif
				begif [s== [pipe::prr MEM_RESP rd_addr] rs2_addr]
					begif [s&& [pipe::issucc MEM_RESP] [pipe::prr MEM_RESP rd_rdy]]
						pipe::accum rs2_rdata [pipe::prr MEM_RESP rd_wdata]
					endif
					begelse
						pipe::pstall
					endif
			...
			# pipeline MEM_REQ forwarding
			begif [s&& [pipe::isworking MEM_REQ] [pipe::prr MEM_REQ rd_req]]
				begif [s== [pipe::prr MEM_REQ rd_addr] rs1_addr]
					begif [s&& [pipe::issucc MEM_REQ] [pipe::prr MEM_REQ rd_rdy]]
						pipe::accum rs1_rdata [pipe::prr MEM_REQ rd_wdata]
					endif
					begelse
						pipe::pstall
					endif
				endif
				begif [s== [pipe::prr MEM_REQ rd_addr] rs2_addr]
					begif [s&& [pipe::issucc MEM_REQ] [pipe::prr MEM_REQ rd_rdy]]
						pipe::accum rs2_rdata [pipe::prr MEM_REQ rd_wdata]
					endif
					begelse
						pipe::pstall
					endif
