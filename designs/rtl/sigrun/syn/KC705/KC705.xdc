## SYSCLK ##
set_property PACKAGE_PIN AD12 [get_ports CLK200MHZ_P]
set_property IOSTANDARD LVDS [get_ports CLK200MHZ_P]
set_property PACKAGE_PIN AD11 [get_ports CLK200MHZ_N]
set_property IOSTANDARD LVDS [get_ports CLK200MHZ_N]
...
## Pushbutton switches ##
#set_property PACKAGE_PIN AG5 [get_ports BTNE]
#set_property IOSTANDARD LVCMOS15 [get_ports BTNE]
set_property PACKAGE_PIN G12 [get_ports BTNC]
set_property IOSTANDARD LVCMOS25 [get_ports BTNC]
#set_property PACKAGE_PIN AA12 [get_ports BTNN]
#set_property IOSTANDARD LVCMOS15 [get_ports BTNN]
#set_property PACKAGE_PIN AB12 [get_ports BTNS]
#set_property IOSTANDARD LVCMOS15 [get_ports BTNS]
#set_property PACKAGE_PIN AC6 [get_ports BTNW]
#set_property IOSTANDARD LVCMOS15 [get_ports BTNW]

## USB-UART ##
set_property PACKAGE_PIN M19 [get_ports UART_TXD_IN]
set_property IOSTANDARD LVCMOS25 [get_ports UART_TXD_IN]
#set_property PACKAGE_PIN K23 [get_ports USB_RTS]
#set_property IOSTANDARD LVCMOS25 [get_ports USB_RTS]
set_property PACKAGE_PIN K24 [get_ports UART_RXD_OUT]
set_property IOSTANDARD LVCMOS25 [get_ports UART_RXD_OUT]
