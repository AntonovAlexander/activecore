...
add_cells_to_pblock [get_pblocks pblock_tile0] [get_cells -quiet [list mpss/tile0]]
...
add_cells_to_pblock [get_pblocks pblock_tile1] [get_cells -quiet [list mpss/tile1]]
...
add_cells_to_pblock [get_pblocks pblock_tile2] [get_cells -quiet [list mpss/tile2]]
...
add_cells_to_pblock [get_pblocks pblock_tile3] [get_cells -quiet [list mpss/tile3]]
...
add_cells_to_pblock [get_pblocks pblock_xbar] [get_cells -quiet [list mpss/xbar]]
