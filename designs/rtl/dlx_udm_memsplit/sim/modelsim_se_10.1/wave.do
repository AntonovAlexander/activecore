...
add wave -noupdate -expand -group {DLX instrpipe combs} -expand -group {IDECODE combs} -expand -group {DLX instr resp bus} -radix hexadecimal /dlx_tb/dlx_udm/dlx/instr_mcopipe_ack
...
add wave -noupdate -expand -group {DLX instrpipe combs} -expand -group {WB combs} -expand -group {DLX data resp bus} -radix hexadecimal /dlx_tb/dlx_udm/dlx/data_mcopipe_ack
...
WaveRestoreCursors {{Cursor 1} {2232745451 ps} 0}
...
update
WaveRestoreZoom {5652596225 ps} {7929510725 ps}
