...
add wave -noupdate -expand -group {DLX instrpipe combs} -expand -group {MEM combs} -expand -group {DLX data bus} -radix hexadecimal /dlx_tb/dlx_udm/dlx/data_mem_req
add wave -noupdate -expand -group {DLX instrpipe combs} -expand -group {MEM combs} -expand -group {DLX data bus} -radix hexadecimal /dlx_tb/dlx_udm/dlx/data_mem_we
add wave -noupdate -expand -group {DLX instrpipe combs} -expand -group {MEM combs} -expand -group {DLX data bus} -radix hexadecimal /dlx_tb/dlx_udm/dlx/data_mem_addr
add wave -noupdate -expand -group {DLX instrpipe combs} -expand -group {MEM combs} -expand -group {DLX data bus} -radix hexadecimal /dlx_tb/dlx_udm/dlx/data_mem_wdata
add wave -noupdate -expand -group {DLX instrpipe combs} -expand -group {MEM combs} -expand -group {DLX data bus} -radix hexadecimal /dlx_tb/dlx_udm/dlx/data_mem_be
...
WaveRestoreCursors {{Cursor 1} {2738135983 ps} 0}
...
update
WaveRestoreZoom {0 ps} {8206448250 ps}
