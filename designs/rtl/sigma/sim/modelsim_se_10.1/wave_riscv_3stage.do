...
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_active_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_broken_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_rd_addr_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_rd_req_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_rd_source_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_jump_req_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_mem_req_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_mem_cmd_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/clk_i
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/rst_i
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_active_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_broken_ff
...
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_mem_req_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_mem_cmd_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {EXEC ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_rd_wdata_ff
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {MEMWB ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/clk_i
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {MEMWB ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/rst_i
...
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {EXEC combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_genpctrl_activereq_next
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {EXEC combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_genpctrl_killreq_next
...
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/clk_i
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/rst_i
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_initiated
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_activereq
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_killreq
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_broken
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_repeatreq
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_new
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_working
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_succ
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_finish
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_stalled
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_flushreq
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_rdy
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_rd_req
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_rd_addr
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_rd_wdata
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_rd_source
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_mem_req
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_mem_cmd
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_mem_addr
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_mem_wdata
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genmcopipe_data_mem_genvar_req_done
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genmcopipe_data_mem_genvar_rdreq_pending
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genmcopipe_data_mem_genvar_resp_done
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genmcopipe_data_mem_genvar_rdata
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data req bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_req
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data req bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_ack
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data req bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_we
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data req bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_addr
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data req bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_wdata
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data req bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_be
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data req bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mcopipe_req
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data req bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mcopipe_we
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data req bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mcopipe_ack
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data req bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mcopipe_wdata
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data reqbuf} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_init_req
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data reqbuf} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_init_we
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data reqbuf} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_init_wdata
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data reqbuf} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_reqbuf_req
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data reqbuf} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_reqbuf_we
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data reqbuf} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_reqbuf_wdata
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data reqbuf} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_reqbuf_rdy
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/clk_i
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/rst_i
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_initiated
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genpctrl_activereq
...
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_mem_req
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_mem_cmd
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_mem_rdata
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genmcopipe_data_mem_genvar_req_done
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genmcopipe_data_mem_genvar_rdreq_pending
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genmcopipe_data_mem_genvar_resp_done
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEMWB_genmcopipe_data_mem_genvar_rdata
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data resp bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_resp
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data resp bus} -radix hexadecimal -childformat {{{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[31]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[30]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[29]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[28]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[27]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[26]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[25]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[24]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[23]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[22]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[21]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[20]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[19]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[18]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[17]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[16]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[15]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[14]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[13]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[12]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[11]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[10]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[9]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[8]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[7]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[6]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[5]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[4]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[3]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[2]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[1]} -radix hexadecimal} {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[0]} -radix hexadecimal}} -subitemconfig {{/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[31]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[30]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[29]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[28]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[27]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[26]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[25]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[24]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[23]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[22]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[21]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[20]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[19]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[18]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[17]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[16]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[15]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[14]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[13]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[12]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[11]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[10]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[9]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[8]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[7]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[6]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[5]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[4]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[3]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[2]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[1]} {-height 15 -radix hexadecimal} {/riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata[0]} {-height 15 -radix hexadecimal}} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mem_rdata
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data resp bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mcopipe_resp
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEMWB combs} -expand -group {riscv data resp bus} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/data_mcopipe_rdata
