...
add wave -noupdate -expand -group inst_mem -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_instr_mem_resp_genfifo_req_i
add wave -noupdate -expand -group inst_mem -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_instr_mem_resp_genfifo_ack_o
add wave -noupdate -expand -group inst_mem -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_instr_mem_resp_genfifo_rdata_bi
add wave -noupdate -expand -group data_mem -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_req_genfifo_req_o
add wave -noupdate -expand -group data_mem -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_req_genfifo_ack_i
add wave -noupdate -expand -group data_mem -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_req_genfifo_wdata_bo
add wave -noupdate -expand -group data_mem -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_resp_genfifo_req_i
add wave -noupdate -expand -group data_mem -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_resp_genfifo_ack_o
add wave -noupdate -expand -group data_mem -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_data_mem_resp_genfifo_rdata_bi
...
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {IDECODE ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/clk_i
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {IDECODE ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/rst_i
...
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {MEM ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/clk_i
add wave -noupdate -expand -group {riscv instrpipe ffs} -expand -group {MEM ffs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/rst_i
...
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_instr_mem_req_genfifo_req_o
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_instr_mem_req_genfifo_ack_i
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} -radix hexadecimal /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genmcopipe_instr_mem_req_genfifo_wdata_bo
...
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/gen975_comb
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/gen960_comb
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/gen249_var
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IFETCH_instr_req_done
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IFETCH_genpctrl_active_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IFETCH_genpctrl_stalled_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IFETCH_genpctrl_killed_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IFETCH combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/gen673_genpstage_IFETCH_mcopipe_rdreq_inprogress
...
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IDECODE combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IDECODE_genpctrl_active_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IDECODE combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IDECODE_genpctrl_stalled_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IDECODE combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IDECODE_genmcopipe_stallreq_unblk
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IDECODE combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IDECODE_genpctrl_killed_glbl
...
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IDECODE combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IDECODE_genpctrl_nevictable
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IDECODE combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IDECODE_genmcopipe_handle_instr_mem_genvar_if_id
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IDECODE combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IDECODE_genmcopipe_handle_instr_mem_genvar_rdreq_pending
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IDECODE combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IDECODE_genmcopipe_handle_instr_mem_genvar_tid
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IDECODE combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IDECODE_genmcopipe_handle_instr_mem_genvar_resp_done
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {IDECODE combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_IDECODE_genmcopipe_handle_instr_mem_genvar_rdata
...
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {EXEC combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_genpctrl_active_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {EXEC combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_genpctrl_stalled_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {EXEC combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_EXEC_genpctrl_killed_glbl
...
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEM combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEM_genpctrl_active_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEM combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEM_genpctrl_stalled_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {MEM combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_MEM_genpctrl_killed_glbl
...
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {WB combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_WB_genpctrl_active_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {WB combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_WB_genpctrl_stalled_glbl
add wave -noupdate -expand -group {riscv instrpipe combs} -expand -group {WB combs} /riscv_tb/sigma/cpu_wrapper/genblk1/riscv/genpstage_WB_genpctrl_killed_glbl
