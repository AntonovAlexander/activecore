...
open class hw_imm (val dimensions : hw_dim_static, var base_type : IMM_BASE_TYPE, val imm_value : String) : hw_param(hw_type(VAR_TYPE.BV_UNSIGNED, dimensions), imm_value)
{
