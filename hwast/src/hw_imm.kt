...
class hw_imm (val dimensions : hw_dim_static, var immtype : IMM_TYPE, val imm_value : String) : hw_param(PARAM_TYPE.VAL, hw_type(VAR_TYPE.UNSIGNED, dimensions), imm_value)
{
    constructor(dimensions : hw_dim_static, imm_value : String) : this(dimensions, IMM_TYPE.LEAF, imm_value)
