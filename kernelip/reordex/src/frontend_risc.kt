                    ...
                    run {
                        ...
                        run {
                            ...
                            for (rd_idx in 0 until MultiExu_CFG.rds.size) {         // TODO: sum rd reqs
                                cyclix_gen.begif(cyclix_gen.band(TranslateVar(MultiExu_inst.RISCDecode.rdctrls[MultiExu_CFG.rds[rd_idx]]!!.req), cyclix_gen.rand(global_structures.PRF_mapped_buf)))
                                run {
                            ...
                            run {
                                ...
                                for (rd_idx in 0 until MultiExu_CFG.rds.size) {
                                    ...
                                    run {
                                        cyclix_gen.assign(nru_rd_tag_prev, global_structures.RenameReg(TranslateVar(MultiExu_inst.RISCDecode.rdctrls[MultiExu_CFG.rds[rd_idx]]!!.addr)))
